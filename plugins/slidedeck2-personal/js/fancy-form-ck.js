...
(function(e) {
  ...
  FancyForm.prototype.showOptions = function(t) {
    ...
    var o = t.closest(".fancy-select").offset(), u = e(window).height(), f = e(window).scrollTop(), l = this.dropdown.outerHeight(), c = s.find(".option").outerHeight();
    if (l + o.top > u + f && u > l && o.top - f > l) {
